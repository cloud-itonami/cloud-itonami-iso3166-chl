# cloud-itonami-iso3166-chl

Open ISO 3166 Blueprint for **CHL**: Chile.
...
tax registration, and local-content rules in Chile, so the operator
...
- **Not the government of Chile.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Chilean-licensed counsel
...
(ISO 3166 `CHL`). Required capabilities:
